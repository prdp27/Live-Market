...
def calculate_and_save(silver, gold, usd_inr, nse, bse):
    ...
    #silver_Agency_Premium=1 # Bank/Nominated Agency Premium: Wholesalers usually add a small dollar premium
    #silver=silver+silver_Agency_Premium
    silver_g = (silver / grams_per_toz) * usd_inr * 1.15
    silver_kg = silver_g * 1000

    #gold_Agency_Premium = 4 # Bank/Nominated Agency Premium: Wholesalers usually add a small dollar premium
    #gold = gold + gold_Agency_Premium
    ...
    data_row = [
        ...
        f"{bse:.6f}" if bse is not None else "",
    ]
